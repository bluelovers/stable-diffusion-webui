...
shared.options_templates.update(shared.options_section(('extra_networks', "Extra Networks"), {
    ...
    "lora_not_found_warning_console": shared.OptionInfo(True, "Lora not found warning in console"),
    "lora_not_found_gradio_warning": shared.OptionInfo(True, "Lora not found warning popup in webui"),
}))
